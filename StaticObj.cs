public class StaticObj
{
	...
	public static int[][] TYPEBG = new int[17][]
	{
		...
		new int[4] { 11, -1, -1, -1 },
		new int[4] { 13, 13, -1, -1 },
		new int[4] { 14, 14, 14, -1 },
		new int[4] { 15, 15, -1, -1 },
		new int[4] { 16, 16, 16, -1 }
	};

	public static int[] SKYCOLOR = new int[17]
	{
		5944047, 4751608, 1052688, 2672631, 3262455, 0, 12451839, 3248838, 1513480, 16760764,
		0, 1285290, 1285290, 0, 4882101, 3018762, 4352644
	};
}
